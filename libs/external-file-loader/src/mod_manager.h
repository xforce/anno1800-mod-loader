...
private:
    ...
    void ReadCache();
    std::optional<std::string> CheckCacheLayer(
...
{
    j = nlohmann::json{ { "input_hash", p.input_hash }, { "patch_hash", p.patch_hash },
        { "output_hash", p.output_hash }, { "layer_file", p.layer_file },
        { "mod_name", p.mod_name } };
}
